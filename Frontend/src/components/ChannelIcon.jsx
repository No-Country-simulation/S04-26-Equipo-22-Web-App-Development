const PATHS = {
  newsletter: (
    <path d="M3 4h18a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 4.236V18h18V8.236l-8.445 5.46a1 1 0 0 1-1.11 0L3 8.236zM3.5 6l8.5 5.5L20.5 6h-17z" />
  ),
  linkedin: (
...
export default function ChannelIcon({ channel, size = 18, className, ...rest }) {
